...
<body>
  <h1>404 không thể tìm thấy</h1>
  <p>Link bạn truy cập không được tìm thấy</p>
  <a>Muốn làm một cái tương tự?</a> <a href="https://github.com/Tira-tw/cloudflare-host-url" target="_self">Nhấn vào!</a>
</body>`
...
async function handleRequest(request) {
  ...
  if (request.method === "POST") {
    ...
    return new Response(`{"status":500,"key":": Lỗi: thông tin về link là web lậu hoặc virus hoặc không phải link này"}`, {
  ...
  if(!path){
    ...
    const html= await fetch("https://tira-tw.github.io/vietnam-url/"+config.theme+"/index.html")
