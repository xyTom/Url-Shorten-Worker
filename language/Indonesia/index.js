...
<body>
  ...
  <p>Tautan yang Anda kunjungi tidak dapat ditemukan</p>
  <a>Ingin buat yang sama?</a> <a href="https://github.com/Tira-tw/cloudflare-host-url" target="_self">Klik!</a>
</body>`
...
async function handleRequest(request) {
  ...
  if (request.method === "POST") {
    ...
    return new Response(`{"status":500,"key":": Error: informasi URL ini mungkin situs web yang mencurigakan atau mengandung virus atau bukan URL yang benar"}`, {
  ...
  if(!path){
    ...
    const html= await fetch("https://tira-tw.github.io/Indonesia-url/"+config.theme+"/index.html")
