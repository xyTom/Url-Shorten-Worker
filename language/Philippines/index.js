...
<body>
  <h1>404 Hindi Natagpuan.</h1>
  <p>Ang url na binibisita mo ay hindi nahanap.</p>
  <a>gusto gumawa ng pareho?</a> <a href="https://github.com/Tira-tw/cloudflare-host-url" target="_self">click!</a>
</body>`
...
async function handleRequest(request) {
  ...
  if (request.method === "POST") {
    ...
    return new Response(`{"status":500,"key":": Error: Ang impormasyon ng Url ay maaaring website ng isda o virus o hindi ang url na ito"}`, {
  ...
  if(!path){
    ...
    const html= await fetch("https://tira-tw.github.io/philippines-url/"+config.theme+"/index.html")
