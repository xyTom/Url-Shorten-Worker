...
<body>
  <h1>404 找不到檔案!</h1>
  <p>您的提供的網址無法搜尋!,請確定是否正確.</p>
  <a>是否想製作一個?</a> <a href="https://github.com/Tira-tw/cloudflare-host-url" target="_self">點擊我!</a>
</body>`
...
async function handleRequest(request) {
  ...
  if (request.method === "POST") {
    ...
    return new Response(`{"status":500,"key":": 錯誤! 你提供的網址可能是釣魚網站/病毒/不存在!"}`, {
  ...
  if(!path){
    ...
    const html= await fetch("https://tira-tw.github.io/taiwan-url/"+config.theme+"/index.html")
