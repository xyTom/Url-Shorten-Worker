...
<body>
  <h1>404 找不到档案!</h1>
  <p>您的提供的网址无法搜寻!,请确定是否正确.</p>
  <a>是否想制作一个?</a> <a href="https://github.com/Tira-tw/cloudflare-host-url" target="_self">点击我!</a>
</body>`
...
async function handleRequest(request) {
  ...
  if (request.method === "POST") {
    ...
    return new Response(`{"status":500,"key":": 错误! 你提供的网址可能是钓鱼网站/病毒/不存在!"}`, {
  ...
  if(!path){
    ...
    const html= await fetch("https://tira-tw.github.io/china-url/"+config.theme+"/index.html")
